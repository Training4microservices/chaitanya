...
Final
- http://localhost:8765/currency-exchange/from/USD/to/INRgit commit -m
...
- Group Id: com.training.microservices
...
#### /limits-service/src/main/java/com/training/microservices/limitsservice/bean/Limits.java New
...
#### /limits-service/src/main/java/com/training/microservices/limitsservice/controller/LimitsController.java New
...
#### /limits-service/src/main/java/com/training/microservices/limitsservice/configuration/Configuration.java New

```java
package com.training.microservices.limitsservice.configuration;
...
#### /limits-service/src/main/java/com/training/microservices/limitsservice/controller/LimitsController.java Modified
...
#### /spring-cloud-config-server/src/main/java/com/training/microservices/springcloudconfigserver/SpringCloudConfigServerApplication.java Modified
...
#### /currency-exchange-service/src/main/java/com/training/microservices/currencyexchangeservice/CurrencyExchange.java New
...
#### /currency-exchange-service/src/main/java/com/training/microservices/currencyexchangeservice/CurrencyExchangeController.java New
...
#### /currency-exchange-service/src/main/java/com/training/microservices/currencyexchangeservice/CurrencyExchange.java Modified 
...
- Complete debugging guide for problems with JPA and Hibernate: https://github.com/training/training-initiatives/blob/master/The-in28Minutes-TroubleshootingGuide-And-FAQ/jpa-and-hibernate.md#tables-are-not-created
...
#### /currency-exchange-service/src/main/java/com/training/microservices/currencyexchangeservice/CurrencyExchangeController.java Modified
...
#### /currency-exchange-service/src/main/java/com/training/microservices/currencyexchangeservice/CurrencyExchangeRepository.java New
...
#### /currency-conversion-service/src/main/java/com/training/microservices/currencyconversionservice/CurrencyConversionController.java New
...
#### /currency-conversion-service/src/main/java/com/training/microservices/currencyconversionservice/CurrencyConversion.java New
...
#### /currency-conversion-service/src/main/java/com/training/microservices/currencyconversionservice/CurrencyConversionController.java Modified
...
(1) Ensure that you have the annotation @EnableFeignClients with right packages on the class public class CurrencyConversionServiceApplication @EnableFeignClients("com.training.microservices.currencyconversionservice")
...
#### /currency-conversion-service/src/main/java/com/training/microservices/currencyconversionservice/CurrencyExchangeProxy.java New
...
#### /naming-server/src/main/java/com/training/microservices/namingserver/NamingServerApplication.java Modified
...
#### /currency-conversion-service/src/main/java/com/training/microservices/currencyconversionservice/CurrencyExchangeProxy.java Modified
...
#### /api-gateway/src/main/java/com/training/microservices/apigateway/ApiGatewayConfiguration.java New

```java
package com.training.microservices.apigateway;
...
#### /api-gateway/src/main/java/com/training/microservices/apigateway/LoggingFilter.java New
...
#### /currency-exchange-service/src/main/java/com/training/microservices/currencyexchangeservice/CircuitBreakerController.java New
...
- (5 Docker Compose Backup Files)[https://github.com/training/spring-microservices-v2/tree/main/04.docker/backup]
